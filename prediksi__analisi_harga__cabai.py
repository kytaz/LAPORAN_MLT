...
Grafik berikut menunjukkan fluktuasi harga cabai dari bulan Agustus 2022 hingga Desember 2023. Terlihat adanya kecenderungan kenaikan harga pada periode menjelang hari raya besar
"""
...
pada tahap ini kita akan melakukan Data Preparation dengan beberapa tahapan yaitu:
- Membagi dataset menjadi data training dan testing.
- Mengatur 'tanggal' sebagai indeks DataFrame.
- Mengatur frekuensi data ke harian.
- Menangani nilai yang hilang (NaN) dengan interpolasi linear

Dalam data preparation ini  untuk memastikan bahwa data yang digunakan untuk melatih model adalah bersih, lengkap, dan dalam format yang sesuai.
...
Pada model yang pertama kita akan menggunakan model ARIMA yang dimana melakukan beberapa tahapan berikut:
- Membagi data menjadi set pelatihan dan penguji.
- Membangun dan melatih model ARIMA dengan order (5, 1, 0).
- Membuat prediksi menggunakan model ARIMA.
- Mengevaluasi model ARIMA menggunakan MAE, RMSE, dan R2.
...
Pada model yang pertama kita akan menggunakan model  Random Forest yang dimana melakukan beberapa tahapan berikut:
- Persiapan data untuk Random Forest (membuat kolom 'date_num').
- Mendefinisikan hyperparameter dan GridSearchCV.
- Melatih model Random Forest menggunakan GridSearchCV.
- Membuat prediksi menggunakan model Random Forest terbaik.
- Mengevaluasi model Random Forest menggunakan MAE, RMSE, dan R2.
...
Pada tahap ini kita dapat mengetahui perbandingan dengan visualisasi data antara model ARIMA dan Random Forest
"""
