...
Sumber data set[Kaggle] 

(https://www.kaggle.com/datasets/muhvannesalqadri/data-harga-jual-cabai-merah-keriting-di-sultra)
...
**Kondisi Data**
 ...
 1. Missing Values: Tidak ada nilai yang hilang (missing values), semua 500 baris pada kedua kolom memiliki data lengkap.
 2. Duplikat: Tidak ada data duplikat, dengan jumlah duplikat yang terdeteksi adalah 0.

**Uraian Seluruh Fitur pada Data:**

1. Kolom pertama (date) berisi data tanggal dalam format teks (object).
2. Kolom kedua (value) berisi harga cabai dalam format numerik (integer).
3. Statistik deskriptif untuk kolom value 


**Tautan Sumber Data:**

Dataset ini dapat ditemukan di Kaggle pada tautan berikut 

https://www.kaggle.com/datasets/muhvannesalqadri/data-harga-jual-cabai-merah-keriting-di-sultra 

**Deskripsi Dataset** 

Dataset ini mencakup data fluktuasi harga cabai dari sekitar bulan Agustus 2022 hingga Desember 2023, dan digunakan untuk melatih dan mengevaluasi model peramalan harga cabai.
...
![image](./images/bangunlatihARIMA.png)
...
![image](./images/prediksiARIMA.png)
